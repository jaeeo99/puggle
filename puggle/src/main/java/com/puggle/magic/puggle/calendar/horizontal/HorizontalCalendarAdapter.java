...
public class HorizontalCalendarAdapter extends RecyclerView.Adapter<HorizontalCalendarAdapter.DayViewHolder> {
    ...
    public void onBindViewHolder(DayViewHolder holder, int position) {
        ...
        holder.txtDayNumber.setText(new SimpleDateFormat(horizontalCalendar.getFormatDayNumber(), horizontalCalendar.getLocaleDayNumber()).format(day));
        ...
        if (horizontalCalendar.isShowDayName()) {
            holder.txtDayName.setText(new SimpleDateFormat(horizontalCalendar.getFormatDayName(), horizontalCalendar.getLocaleDayName()).format(day));
        ...
        if (horizontalCalendar.isShowMonthName()) {
            holder.txtMonthName.setText(new SimpleDateFormat(horizontalCalendar.getFormatMonth(), horizontalCalendar.getLocaleMonth()).format(day));
