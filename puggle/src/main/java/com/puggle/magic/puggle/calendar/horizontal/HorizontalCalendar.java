...
/**
 * Created by jaeeo99 on 2017. 8. 6..
 */
...
public class HorizontalCalendar {
    ...
    private final Locale localeDayName;
    private final Locale localeDayNumber;
    private final Locale localeMonth;
    ...
    private HorizontalCalendar(Builder builder) {
        ...
        this.localeDayName = builder.localeDayName;
        this.localeDayNumber = builder.localeDayNumber;
        this.localeMonth = builder.localeMonth;
    ...
    public Locale getLocaleDayName() {
        return localeDayName;
    }

    public Locale getLocaleDayNumber() {
        return localeDayNumber;
    }

    public Locale getLocaleMonth() {
        return localeMonth;
    }
    ...
    public static class Builder {
        ...
        String formatMonth;
        Locale localeDayName;
        Locale localeDayNumber;
        Locale localeMonth;
        ...
        public Builder dayNameLocale(Locale locale) {
            this.localeDayName = locale;
            return this;
        }

        public Builder dayNumberLocale(Locale locale) {
            this.localeDayNumber = locale;
            return this;
        }

        public Builder monthLocale(Locale locale) {
            this.localeMonth = locale;
            return this;
        }
        ...
        private void initDefaultValues() {
            ...
            if ((localeDayName == null) && showDayName) {
                localeDayName = Locale.getDefault();
            }
            if (formatDayNumber == null) {
                formatDayNumber = "dd";
            }
            if (localeDayNumber == null) {
                localeDayNumber = Locale.getDefault();
            }
            if ((formatMonth == null) && showMonthName) {
                formatMonth = "MMM";
            }
            if ((localeMonth == null) && showMonthName) {
                localeMonth = Locale.getDefault();
            }
